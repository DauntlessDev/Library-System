...
public class Dashboard extends JFrame implements InputValidator {
	...
	public Dashboard() {
		...
		JLabel memberLabel = new JLabel("Patron Dashboard");
		...
		JButton updateButton = new JButton("EDIT PATRON");
		...
		JButton sortButton = new JButton("SORT PATRONS");
		...
		JButton btnBooksTable = new JButton("CHECK BOOKS ");
		btnBooksTable.setFont(new Font("Tahoma", Font.BOLD, 10));
		btnBooksTable.setBackground(Color.WHITE);
		btnBooksTable.setBounds(30, 355, 120, 30);
		leftBluePanel.add(btnBooksTable);
		...
		Object[] columns = { "Login ID.", "First Name", "Last Name", "Address", "Can Borrow",
				"Books Borrowed", "Fine" };
